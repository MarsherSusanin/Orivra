...
| 028B | Byte-preserving GHCR publication and DigitalOcean staging | Fixed 1 MiB chunk corrective RED after real first-PATCH socket failure; prior PASS covers superseded bytes; 0 images/evidence/staging |
