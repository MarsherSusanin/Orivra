...
| 028B | Byte-preserving GHCR publication and DigitalOcean staging | Fixed 256 KiB transport-bound corrective RED after real 1 MiB PATCH socket failure; 0 images/evidence/staging |
