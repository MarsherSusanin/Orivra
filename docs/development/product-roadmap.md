...
| 028B | Byte-preserving GHCR publication and DigitalOcean staging | GHCR chunked-upload corrective RED after real Caddy-layer socket failure; prior PASS `70f63cb` / `88ec383` covers superseded bytes; 0 images/evidence/staging |
