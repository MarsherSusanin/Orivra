...
| 028B | Byte-preserving GHCR publication and DigitalOcean staging | Local production-author GREEN; two implementation verifiers plus credentialed GHCR/staging execution pending explicit target map and credentials |
