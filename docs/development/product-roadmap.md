...
| 028B | Byte-preserving GHCR publication and DigitalOcean staging | Corrective RED after Core rejected `be3270c` / `0c12d82` for mutable async target/run authority; two independent verifiers and credentialed effects pending |
