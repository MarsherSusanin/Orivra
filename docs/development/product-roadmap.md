...
| 028B | Byte-preserving GHCR publication and DigitalOcean staging | Core and Product PASS `70f63cb` / `88ec383`; GHCR attempt published 0 images and wrote no PASS evidence because a classic package-write PAT is still required; staging pending |
