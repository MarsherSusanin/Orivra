...
| 028B | Byte-preserving GHCR publication and DigitalOcean staging | Corrective RED after Core rejected `7c2ca21` / `34a5751` for mutable post-verification staging authority; two independent verifiers and credentialed effects pending |
