...
| 028B | Byte-preserving GHCR publication and DigitalOcean staging | Corrective RED after Core rejected `5322125` / `bad14e5`; replacement and two verifiers pending, no credentialed effects |
