...
| 028B | Byte-preserving GHCR publication and DigitalOcean staging | Singular GHCR Location production-author GREEN; fresh Core/Product verification pending; prior PASS `70f63cb` / `88ec383` covers superseded bytes; 0 images/evidence/staging |
