...
| 028B | Byte-preserving GHCR publication and DigitalOcean staging | Compatibility RED after real GHCR returned singular same-repo `blobs/upload/<id>`; prior PASS `70f63cb` / `88ec383` covers superseded bytes; 0 images/evidence/staging |
