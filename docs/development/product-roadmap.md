...
| 028B | Byte-preserving GHCR publication and DigitalOcean staging | Fixed 1 MiB chunk production-author GREEN on RED base `a34b424` / `bdc1d48`; fresh two-verifier PASS pending; 0 images/evidence/staging |
