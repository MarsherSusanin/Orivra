...
| 028A | Verified local OCI archives and frozen digest manifest | Second corrective RED after Core FAIL `1d3324d` / `473c534`; replacement and two verifier PASS reports pending, credential-free |
