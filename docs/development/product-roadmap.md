...
| 028B | Byte-preserving GHCR publication and DigitalOcean staging | Production-author GREEN after correcting rejected `7c2ca21` / `34a5751`; two independent verifiers and credentialed effects pending |
