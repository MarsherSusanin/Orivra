...
| 028B | Byte-preserving GHCR publication and DigitalOcean staging | Chunked upload production-author GREEN on RED base `756a4aa` / `7a064e0`; fresh two-verifier PASS pending; 0 images/evidence/staging |
