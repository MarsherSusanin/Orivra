...
| 028B | Byte-preserving GHCR publication and DigitalOcean staging | Fixed 256 KiB transport production-author GREEN on RED base `a47e646` / `7bac35d`; fresh two-verifier PASS pending; 0 images/evidence/staging |
