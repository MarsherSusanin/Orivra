...
| 028B | Byte-preserving GHCR publication and DigitalOcean staging | Production-author GREEN after correcting rejected `9cb839f` / `fcd0d75`; two independent verifiers and credentialed effects pending |
