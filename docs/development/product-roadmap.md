...
| 028B | Byte-preserving GHCR publication and DigitalOcean staging | Upload-session `Connection: close` corrective RED after real 256 KiB PATCH socket failure; 0 images/evidence/staging |
