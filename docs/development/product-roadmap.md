...
| 028B | Byte-preserving GHCR publication and DigitalOcean staging | Production-author GREEN locally after correcting rejected `5322125` / `bad14e5`; two independent verifiers and credentialed effects pending |
