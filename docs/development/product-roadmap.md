...
| 028A | Verified local OCI archives and frozen digest manifest | Second corrective production-author GREEN after Core FAIL `1d3324d` / `473c534`; final freeze and two verifier PASS reports pending, credential-free |
