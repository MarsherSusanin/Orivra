...
| 028B | Byte-preserving GHCR publication and DigitalOcean staging | Stable-current Location production-author GREEN on RED base `566e4b8` / `6e63468`; fresh two-verifier PASS pending; 0 images/evidence/staging |
