...
The production-author replacement is GREEN locally and binds canonical
bytes/checksums transitively, typed staging evidence, a pinned SSH session and
one bounded no-follow archive lease. Two independent verifier PASS reports are
